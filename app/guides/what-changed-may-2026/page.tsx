...
export default function Page() {
  return (
    <GuideLayout
      ...
      intro="The Renters' Rights Act 2025 came into force on 1 May 2026. It's the biggest reform of the private rented sector in nearly 40 years. Here's what changed, what it means in practice, and what's still being phased in over the next few years."
      readTime="8 min read"
    >
      <p>
      ...
      <p>
        ...
        day, not every legal subtlety. For the full picture, the Act itself is
        on{" "}
        <a
        ...
        is a useful plain-English summary that your landlord is legally
        required to give you by 31 May 2026.
      </p>

      <h2 id="section-21">Section 21 is gone</h2>
      <p>
        ...
        notice. To end your tenancy, they now have to use a Section&nbsp;8
        notice and prove a specific legal ground from the updated Schedule&nbsp;2
      ...
      <div className="callout">
        <strong>Transition rule:</strong> If your landlord served a valid
        Section 21 notice before 1 May 2026, it remains valid — but they have
        to bring possession proceedings before the earlier of (a) six months
        from the date of the notice, or (b) 31 July 2026. After that, the
        notice expires.
      </div>

      <h2 id="periodic">Every tenancy is now periodic</h2>
      <p>
      ...
      <p>
        ...
        was automatic in law. If you&apos;re still inside what was supposed to
        be a fixed term, your fixed term ended on 1 May 2026 and you&apos;re
        now on a periodic tenancy under the same other terms.
      </p>
      <p>
        Practical effect for tenants: you can give two months&apos; written
        notice to leave at any point. No early-termination fees, no break
        clauses, no being trapped until the &quot;next renewal&quot;. The
        flexibility now sits with you, not the landlord.
      </p>

      <h2 id="rent-increases">Rent increases must go through Section 13</h2>
      <p>
        From 1 May 2026, the only legal way for a landlord to increase rent on
        an assured tenancy is by serving a Section&nbsp;13 notice on the new
        prescribed{" "}
        <strong>Form&nbsp;4A</strong>. Any rent review clause written into your
        tenancy agreement is no longer enforceable. A landlord cannot raise
        the rent by sending a letter, an email, a text, or pointing at a
      ...
      <p>
        ...
        new rent date. A genuinely important change: <strong>the tribunal can
        no longer set the rent higher than your landlord proposed</strong>. Under
        the old rules, the tribunal could increase it further, which scared
        most tenants away from challenging. That deterrent is gone. The
        tribunal can also defer the increase by up to two more months if
        paying immediately would cause undue hardship.
      </p>
      <p>
      ...
      <h2 id="pets">You can request a pet</h2>
      <p>
        Tenants now have a statutory right to request permission to keep a pet
        in the property. The landlord must consider the request reasonably and
        can only refuse on reasonable grounds. Blanket &quot;no pets&quot;
        clauses in tenancy agreements are no longer enforceable.
      </p>
      <p>
      ...
      <h2 id="bidding">No more rental bidding wars</h2>
      <p>
        Landlords and letting agents must advertise a specific rent and cannot
        accept or invite offers above the advertised amount. The Act also caps
        rent in advance: <strong>no more than one month&apos;s rent</strong>{" "}
      ...
      <h2 id="discrimination">Discrimination is now banned</h2>
      <p>
      ...
      <p>
        ...
        Standard for the first time. Awaab&apos;s Law — named after Awaab Ishak,
        the toddler who died in 2020 from prolonged exposure to mould — applies
        to private rentals too, setting statutory time limits for landlords to
        respond to and remedy serious health hazards.
      </p>

      <h2 id="info-sheet">The Information Sheet deadline</h2>
      <p>
      ...
      <h2 id="protected-period">The 12-month Initial Protected Period</h2>
      <p>
        ...
        themselves or moving in a close family member) or <strong>Ground 1A</strong>{" "}
        (intending to sell the property) to evict you. These two grounds are
        otherwise mandatory — meaning the court must grant possession if
        proved — and Ground&nbsp;1A is brand new in the Act.
      </p>
      <p>
      ...
      <h2 id="phasing">What&apos;s still coming</h2>
      <p>
      ...
      <ul>
        <li>
          <strong>Late 2026</strong> — Private Rented Sector Database goes live
          regionally, with full national rollout in 2027. Landlords will have
          to register themselves and their properties.
        </li>
        <li>
      ...
      <p>
        We&apos;ll update this guide as each phase comes into force.
      </p>
      ...
      <p>
        ...
        . They&apos;re the people who can actually pick up the phone.
      </p>
    </GuideLayout>
  );
}
