...
export default function Page() {
  return (
    <GuideLayout
      ...
      intro="Every rent increase on an assured tenancy in England now has to follow the Section 13 procedure. That sounds dry, but it's a huge shift — and the new rules genuinely favour tenants who know them."
      readTime="7 min"
    >
      ...
      <p>
        ...
        changed. The form is new (Form&nbsp;4A, not Form 4), the notice
        period doubled, and the tribunal&apos;s powers were rebalanced toward
        tenants. Here&apos;s how it works now.
      </p>

      <h2 id="three-rules" data-num="1">The three rules every increase must follow</h2>
      <p>
      ...
      <p>
        ...
        or the start of your tenancy if it&apos;s never been increased. So
        if your tenancy began on 1 January 2026 and your landlord has never
      ...
      <p>
        The minimum notice period under the new Act is two months between
        the date the Form&nbsp;4A is served on you and the date the new rent
      ...
      <div className="note">
        <span className="note-label">Useful tool</span>
        Use our free <a href="/rent-increase-check">rent increase check</a> to
        run any notice you&apos;ve received against these three rules in
        about a minute. It&apos;s stateless — we don&apos;t see the figures
        you enter.
      </div>

      <h2 id="rent-review" data-num="2">Rent review clauses no longer work</h2>
      <p>
        This is one of the biggest practical changes. Most tenancy
        agreements signed before 1 May 2026 include a clause permitting the
        landlord to increase rent on a fixed schedule, often tied to CPI or
        a set percentage. Under the old system these clauses were
      ...
      <p>
        ...
        effect. Even if your contract says &quot;rent shall increase by 5%
        on each anniversary&quot;, that clause is now legally void. Your
        landlord must use Form 4A or wait.
      </p>

      <h2 id="market-rent" data-num="3">What &quot;market rent&quot; actually means</h2>
      <p>
        The legal test for whether a tribunal will reduce a proposed
        increase is whether the proposed rent exceeds the{" "}
        <strong>open-market rent</strong> for the property. Not a percentage.
        Not affordability. Not comparison to inflation. Market rent.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>The ONS Private Rental Market Statistics</strong> —
          quarterly official figures by region, broken down by property
          size. Useful for a sanity check on the trajectory of rents in your
          area.
        </li>
        <li>
          <strong>Letting agent valuations</strong> — most agents will give
          a free informal market opinion if you ask. They&apos;re trying to
          win your business, so take it as one data point.
        </li>
      </ul>
      <p>
        If three to five comparable properties in your postcode are renting
        at similar levels to your landlord&apos;s proposed figure, a
        tribunal challenge is unlikely to succeed. If they&apos;re
        consistently lower, you have a real argument.
      </p>
      ...
      <blockquote>
        The tribunal can no longer set rent higher than your landlord
        proposed. The worst case is the rent stays where the notice says.
      </blockquote>
      <p>
        Under the old rules, the tribunal could determine an open-market
        rent that was higher than the landlord&apos;s figure, which scared
        most tenants out of challenging. That deterrent is now gone. The
        best case is the tribunal reduces it.
      </p>
      <p>
        ...
        meaning you owed arrears. From 1 May 2026, the new rent (whatever
        the tribunal sets it at) only takes effect from the date of the
        tribunal&apos;s decision.
      </p>
      <p>
      ...
      <h2 id="rules-broken" data-num="5">What if the rules aren&apos;t followed</h2>
      <p>
      ...
      <p>
        Your landlord can serve a new, valid notice — but they have to
        start the two-month clock again. So a defective notice typically
        costs the landlord two months of the increased rent.
      </p>
      <p>
        You don&apos;t need to <em>do</em> anything to invalidate a
        defective notice. It&apos;s invalid by operation of law. But
        it&apos;s sensible to write to your landlord explaining why the
        notice doesn&apos;t comply, so there&apos;s no confusion about what
        rent is payable.
      </p>

      <h2 id="mistakes" data-num="6">Common mistakes landlords are making</h2>
      <p>
