  ...
  return (
    <article className="mx-auto max-w-2xl px-5 sm:px-8 pt-12 sm:pt-16 pb-20">
      <nav className="text-sm text-mute mb-5">
        ...
        <span aria-hidden className="mx-1">›</span> Privacy
      </nav>
      ...
      <header className="mb-8">
        ...
        <h1 className="display text-4xl sm:text-5xl leading-tight tracking-tight">
          What we collect.{" "}
          <span className="display-italic">Nothing.</span>
        </h1>
      ...
      <div className="prose">
        ...
        <p>
          Nothing. Renters Hub doesn&apos;t require you to sign up, hand over
          personal details, or create an account. The tools on this site run
          entirely in your browser — the figures you enter (rent amounts,
          dates, postcode) are never sent to our servers and are not stored
          anywhere.
        </p>
        ...
        <p>
          ...
          dismissed the cookie banner. That&apos;s the entirety of our cookie
          policy.
        </p>
        <p>
          We don&apos;t use:
        ...
        <p>
          ...
          . We do not use these logs for analytics, profiling, or advertising.
        </p>

        <h2>If we ever add advertising</h2>
        <p>
          ...
          and domain costs. If and when that happens, this page will be
          updated to explain exactly what AdSense collects, you&apos;ll see a
          clear notice on the site, and the cookie banner will be updated to
          give you a meaningful choice about ad cookies.
        </p>
        <p>
          We will never sell tenant data. We will never pass information you
          enter into the tools to advertisers or anyone else.
        </p>

        <h2>Your rights under UK GDPR</h2>
        <p>
          Because we don&apos;t collect personal data, there&apos;s nothing
          for you to access, correct, or delete from our records. The Vercel
          server logs above contain IP addresses and are processed under
          Vercel&apos;s privacy policy; for requests relating to those
          contact{" "}
          <a
        ...
        <p>
          ...
          page and the &quot;Last updated&quot; date at the top. We won&apos;t
          retroactively reduce your privacy without flagging it prominently
